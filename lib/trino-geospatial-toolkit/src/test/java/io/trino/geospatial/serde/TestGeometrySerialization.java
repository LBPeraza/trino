...
public class TestGeometrySerialization
{
    ...
    {
        // Envelopes are serialized as Polygons in WKB
    ...
    private void testEnvelopeSerialization(Envelope envelope)
    {
        ...
        // Envelope serializes as a polygon
        ...
        // Envelope extraction should match
    ...
    public void testDeserializeType()
    {
        ...
        // Envelope serializes as POLYGON in WKB
    ...
    private static void testSerialization(String wkt)
    {
        ...
        // Compare normalized geometries for semantic equality
